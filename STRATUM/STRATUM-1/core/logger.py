...
def setup_logger():
    ...
    # [KST-FORCE] Force UTC+9 for Imperial Timekeeping
    def kst_converter(*args):
        # We manually offset because TZ env might be unreliable on Windows
        return (datetime.now(timezone.utc) + timedelta(hours=9)).timetuple()
